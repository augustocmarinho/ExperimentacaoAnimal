        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8">
                            <h5>Listagem de Animais</h5>
                        </div>
                        <div class="col-md-4" style="text-align:right"> 
                            <a href="{{ url('/animais/cadastrar') }}" class="btn btn-primary" style="align">Novo</a>
                        </div>
                    </div>
                </div>
                <br>
                ...
                <form action="/animais/getByName">
                    <div class="row col-md-12" style="text-align:right">
                        <div class="col-md-10"> <input class="form-control" name="nome"
                                placeholder="Pesquisar por espécie"> </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#" onclick="confirmDelete('<?=$key->codigo?>');" data-toggle="modal"
