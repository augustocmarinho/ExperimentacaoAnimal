        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                     <div class="col-md-8"><h5> Listagem de Biotérios </h5></div>
                    ...
                    <tbody>
                        <?php foreach ($bioterios as $key) { ?>
                            <tr>
                                ...
                                <td><?=$key->nome?></td>
                                <td><?=$key->local?></td>
                                <td><a href="/bioterios/edit?id=<?=$key->id?>"><i class="fas fa-edit"></i></a> <a href="#" onclick="confirmDelete('<?=$key->id?>');" data-toggle="modal" data-target="#Modal"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
